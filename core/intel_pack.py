...
"""Capability source map helpers for Silinosic-X."""
...
def _silinosic_x_meta() -> dict[str, str]:
    return {
...
_FEATURE_DESCRIPTIONS: dict[str, str] = {
    ...
    "signal_fusion_lane": "Unified connector lanes for integrating multi-source intelligence into silinosic_x workflows.",
...
def map_sources_to_core_modules(
    ...
    """Map source-study strengths to Silinosic-X module focus areas."""
...
def write_capability_report(
    output_path: str | Path = "docs/silinosic_x-capability-scan.md",
    *,
...
def _build_plugin_capability_views(
    ...
    *,
    ...
    readme_lines = [
        "# Plugin Intel Views",
        "",
        "silinosic_x-native plugin recommendations by workflow.",
        "",
